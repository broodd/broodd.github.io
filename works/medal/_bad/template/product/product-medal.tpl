...
<section class="section section-product padding-50_80" id="product">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm col-md-5 col-xl-2 margin-md-t_30">
        <div class="row">
          <div class="col-12">
        ...
        <div class="row">
          ...
          <?php } else { ?>
          <div class="col-12 margin-md-t_30">
            <p class="font-14">Зарегистрируйтесь для оформления заказа</p>
          </div>
          <?php } ?>
        </div>
      </div>
      <div class="col-xl-5 margin-md-t_30 margin-b_40 border-xl-l">
        <div class="row">
          <?php if ($options) { ?>
          <?php foreach ($options as $option) { ?>
          <?php if ($option['type'] == 'image') { ?>
          <div class="col-sm-6 col-lg-7 col-xl-12">
            <p class="font bold"><?php echo $option['name']; ?>:</p>
            <div class="slick-wrap slick__5 slick-arrow_small margin-t_30">
              <?php foreach ($option['product_option_value'] as $option_value) { ?>
              <div class="lenta">
                <label>
                <div class="lenta__image">
                  <input type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" />
                  <img src="<?php echo $option_value['image']; ?>" alt="">
                </div>
                <div class="lenta__text">
                  <p class="font-10 color-black"><?php echo $option_value['name']; ?></p>
                  <?php if ($option_value['price']) { ?>
                  <p class="font-10 bold color-blue"><?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?></p>
                  <?php } ?>
                </div>
                </label>
              </div>
          ...
          <div class="col-sm-6 col-lg-5 col-xl-12 margin-t_50">
