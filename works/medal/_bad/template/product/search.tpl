    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-2 text-right">
          <select id="input-sort" class="form-control col-sm-12" onchange="location = this.value;">
        ...
        <div class="col-sm-2 offset-md-4 text-right">
          <label class="control-label" for="input-limit"><?php echo $text_limit; ?></label>
        </div>
        <div class="col-sm-2 text-right">
          <select id="input-limit" class="form-control col-sm-12" onchange="location = this.value;">
      ...
      <div class="row">
        ...
        <div class="product col-sm-6 col-lg-3">
